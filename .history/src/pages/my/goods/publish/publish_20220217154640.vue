<template>
  <view style="height:100%;">
    ...
    >
      ...
      <view v-if="!(otherUser.id && otherUser.id != user.id)" @click="notRelease" class="fixed-add-btn">
        <image mode="widthFix" :src="imgHOST+'/icon/the-shelves.png'" />
      </view>
      <view v-if="otherUser.id && otherUser.id != user.id" @click.stop="toNav('/pages/goods/add/add')">
        <button class="btn-donation">我也想捐赠</button>
      </view>
    </scroll-view>
    <canvas
