<template>
  <view style="height:100%;">
    ...
    >
      ...
      <view v-if="!(otherUser.id && otherUser.id != user.id)" class="fixed-add-btn" @click="notRelease">
        <image mode="widthFix" :src="imgHOST+'/icon/the-shelves.png'" />
      </view>
      <view v-if="otherUser.id && otherUser.id != user.id" class="" class="fixed-add-btn" @click="notRelease">
        <image mode="widthFix" :src="imgHOST+'/add/wantDonate.png'" />
      </view>
    </scroll-view>
    <canvas
