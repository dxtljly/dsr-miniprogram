<template>
  ...
  >
          ...
          <block v-if="isOwner">
            <block v-if="detail.status==1">
              ...
              <view class="flx fx-middle">
                ...
                <view class="icon-txt" @click="previewWechat(imgHOST+'/seli群.jpg')">
    ...
    <view v-if="isShowWechatGroupModal" class="wechat-group-modal">
      ...
      />-->
      <image mode="widthFix" :src="imgHOST+'/seli群.jpg'" @longtap.stop="saveGroupQR" />
    </view>
...
export default {
  ...
  methods: {
    ...
    previewWechat() {
      uni.previewImage({
        current: imgHOST + "/seli群.jpg", // 当前显示图片的http链接
        urls: [imgHOST + "/seli群.jpg"] // 需要预览的图片http链接列表
      });
    },
    copy(phone) {
      uni.setClipboardData({
