    ...
    return {
      ...
      FAQ: [
        ...
        },
        {
          title: "为什么大部分商品都是免费的？",
          content:
            "断舍哩上最大的特点就是所有物品只送不卖。赠送者可以轻松送出自己的闲置物品，领取者可免费获得想要的物品，让不可再生的有限资源得到最大限度的循环再利用。\n\n经过身份认证的学生用户，可在“校园专区”出售有价的闲置物品。"
        },
        {
          title: "如何在断舍哩上赠送商品？",
          content:
            "您只需将想赠送出去的闲置物品，拍照后上传至平台即可。无任何费用（运费也有领取者承担），无聊天功能（大大降低时间成本），也无需提供任何售后服务（因为商品本身就是免费的）。操作轻松，简单方便。"
        },
        {
          title: "如何在断舍哩上申领物品？",
          content:
        ...
        },
        {
          title: "关于运费",
          content:
            "免费物品如需快递，运费将由领取者承担，且领取者在下单时已预付邮费给快递公司；赠送者在接到发货通知时，可直接通过断舍哩平台，免费呼叫快递小哥上门收件，此时赠送者不需要再额外支付运费。其他非免费商品及自提商品，是否快递及运费由哪方承担，请买卖双方自行协商确定。"
        },
        {
        ...
        },
        {
          title: "收到与照片不符的商品怎么办？",
          content:
            "如果有赠送者恶意发货或其他恶劣违规情况，您可向平台申诉举报，经核实后，平台会对赠送者进行警告、账号限制或封禁处理。断舍哩的初衷就是为了提倡环保的理念，请各位用户遵守诚实守信的交易原则，维护平台良好氛围，感谢您的配合！"
        },
        {
          title: "为什么邮费比市面上的贵？",
          content:
            "运费收取标准按物品预估重量多加2公斤计算，多退少补。多收的款项会在快递师傅上门取件确认实际运费后，按原路退回（具体运费可参考德邦快递官网）。没有收到退款的用户，有可能实际重量的邮费超过已付款，需要补交运费"
        },
        {
          title: "如何退换货？",
          content:
