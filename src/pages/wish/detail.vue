<template>
  ...
  >
                ...
                <view class="detail">
                  ...
                  <view class="imgs-content">
                    <block v-for="(item,index) in detail.pic" :key="index">
                      <image mode="widthFix" :src="item" @click="previewImgs" :data-index="index" />
                    </block>
                    <!-- <view class="info">
              <text>10人想要</text>
    ...
    <view v-if="isShowWechatGroupModal" class="wechat-group-modal">
      ...
      />-->
      <image mode="widthFix" :src="imgHOST+'/断舍哩群.jpg'" @longtap.stop="saveGroupQR" />
    </view>
...
export default {
  ...
  methods: {
    ...
    previewWechat() {
      uni.previewImage({
        current: imgHOST + "/断舍哩群.jpg", // 当前显示图片的http链接
        urls: [imgHOST + "/断舍哩群.jpg"] // 需要预览的图片http链接列表
      });
    },
    copy(phone) {
      uni.setClipboardData({
