  ...
  <view>
    ...
    <view v-if="isShowTips" class="modal">
      ...
      <view class="modal-content z-depth-1">
        ...
        <view class="txt-info">
          1、在断舍哩只用上架您最想送的闲置物品即可，所以售价都是
          <text class="strong">0</text>。
        </view>
        <view class="txt-info">
          2、买家拍下后会直接付邮费，所以请您务必认真填写“
          <text class="strong">预估重量</text>”和“
          <text class="strong">所在城市</text>”，以免售后造成不必要的纠纷
        </view>
        <view class="txt-info">
          3、
          <text class="strong">关注微信公众号，第一时间获得买家的消息提醒。</text>
        </view>
...
export default {
  ...
  methods: {
    ...
    getConfig() {
      let url =
          "https://image.grecycle.com.cn/src/sli/config/sli-add-config.json",
        data = {};
